...
{
    [LookupScript]
    public class RestoreTRTYLookup : RowLookupScript<ASTRTYRow>
    {
        public RestoreTRTYLookup(ISqlConnections sqlConnections) : base(sqlConnections)
        {
        ...
        protected override void PrepareQuery(SqlQuery query)
        {
            ...
            query.Distinct(true)
                ...
                .Select(fld.Dscr_AR)
                .Where(
                    new Criteria(fld.TR_TY) == (int)TRTYType.RestorePurch &
