...
{
    [LookupScript]
    public class CashPurchTRTYLookup : RowLookupScript<ASTRTYRow>
    {
        public CashPurchTRTYLookup(ISqlConnections sqlConnections) : base(sqlConnections)
        {
        ...
        protected override void PrepareQuery(SqlQuery query)
        {
            ...
            query.Distinct(true)
                ...
                .Select(fld.Dscr_AR)
                .Where(
                    new Criteria(fld.TR_TY) == (int)TRTYType.CashPurchase & 
