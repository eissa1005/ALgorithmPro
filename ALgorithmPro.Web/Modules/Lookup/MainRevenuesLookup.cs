...
{
    [LookupScript]
    public class MainRevenuesLookup : RowLookupScript<ACCMFRow>
    {
        public MainRevenuesLookup(ISqlConnections sqlConnections) : base(sqlConnections)
        {
