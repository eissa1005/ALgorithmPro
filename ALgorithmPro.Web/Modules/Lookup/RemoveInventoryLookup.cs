...
{
    [LookupScript]
    public class RemoveInventoryLookup : RowLookupScript<ASTRTYRow>
    {
        public RemoveInventoryLookup(ISqlConnections sqlConnections) : base(sqlConnections)
        {
        ...
        {
            var TRTY = TRTYType.RemoveInventory;
