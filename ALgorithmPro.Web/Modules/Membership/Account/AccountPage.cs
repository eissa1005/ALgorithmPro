...
namespace ALgorithmPro.Membership.Pages
{
            ...
            [FromServices] IEmailSender emailSender = null)
        {
            return this.ExecuteMethod(() =>
            {
                ...
                if (result == PasswordValidationResult.Valid)
                {
                    ...
                    var userDefinition = principal.GetUserDefinition(userRetriever);
                    CurrentUser.ID = userDefinition.Id;
                    CurrentUser.Username = userDefinition.Username;
