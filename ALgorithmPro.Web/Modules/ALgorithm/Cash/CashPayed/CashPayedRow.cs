...
namespace ALgorithmPro.ALgorithm.Entities
{
    ...
    [DisplayName("CashPayed"), InstanceName("CashPayed")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    [LookupScript("ALgorithm.CashPayed")]
    public sealed class CashPayedRow : Row<CashPayedRow.RowFields>, IIdRow, INameRow
    {
        ...
        [LookupEditor(typeof(CashPayedLookup), AutoComplete = true)]
        public Int32? TR_TY
        {
        ...
        public CashPayedRow(RowFields fields)
            : base(fields)
        {
        }
