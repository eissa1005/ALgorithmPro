...
namespace ALgorithmPro.ALgorithm.Entities
{
    ...
    [DisplayName("CashReceive"), InstanceName("CashReceive")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    [LookupScript("ALgorithm.CashReceive")]
    public sealed class CashReceiveRow : Row<CashReceiveRow.RowFields>, IIdRow, INameRow
    {
        ...
        [LookupEditor(typeof(CashReceiveLookup), AutoComplete = true)]
        public Int32? TR_TY
        {
        ...
        [DisplayName("Account Number"), Column("ACC_NO"), Size(100), NotNull, LookupInclude]
        ...
        [DisplayName("CashBoxID"), Column("CashBoxID"), Size(100), LookupInclude]
        ...
        [DisplayName("Net Total"), DefaultValue(0)]
        ...
        public CashReceiveRow()
            : base()
        {
        }

        public CashReceiveRow(RowFields fields)
            : base(fields)
        {
        }
