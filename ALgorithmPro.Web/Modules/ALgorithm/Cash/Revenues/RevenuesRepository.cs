...
{
    public class RevenuesRepository : BaseRepository
    {
        ...
        public RevenuesRepository(IRequestContext context) : base(context)
        {
            SelectTRTY = TRTYType.Revenu;
        }
        ...
        public SaveResponse Create(IUnitOfWork uow, SaveRequest<MyRow> request)
        {
            ...
            try
            {
                ...
                header.TR_TY = (int)TRTYType.Revenu;
                header.TRTY_NAME = "يومية الخزينة - إيــراد";
                header.TR_DS = (int)TRDSTYPE.Revenu;
        ...
        public ListResponse<MyRow> List(IDbConnection connection, ListRequest request)
        {
            ...
            try
            {
                if (SelectTRTY == TRTYType.Revenu)
                {
                    lst.Entities = connection.List<MyRow>(s => s.SelectTableFields()).Where<MyRow>(x => x.TR_TY == (int)TRTYType.Revenu).ToList();
                    return lst;
                }
                else
                {
        ...
        public static void CashDetail(IDbConnection connection, RevenuesRow ACCTRH)
        {
            if (SelectTRTY == TRTYType.Revenu)
            {
        ...
        public static void UpdateCashDetail(IDbConnection connection, RevenuesRow ACCTRH)
        {
            if (SelectTRTY == TRTYType.Revenu)
            {
