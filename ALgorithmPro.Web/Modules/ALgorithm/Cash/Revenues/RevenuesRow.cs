...
namespace ALgorithmPro.ALgorithm.Entities
{
    ...
    [DisplayName("Revenues"), InstanceName("Revenues")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    [LookupScript("ALgorithm.Revenues")]
    public sealed class RevenuesRow : Row<RevenuesRow.RowFields>, IIdRow, INameRow
    {
        ...
        [LookupEditor(typeof(RevenuesTRTYLookup), AutoComplete = true)]
        public Int32? TR_TY
        {
        ...
        [LookupEditor(typeof(MainRevenuesLookup), AutoComplete = true)]
        ...
        [DisplayName("Revenue Number"), Column("ACC_NO"), Size(100), NotNull, LookupInclude]
        ...
        [DisplayName("Revenue Name"), Column("ACC_NAME"), Size(255), ReadOnly(true)]
        ...
        public RevenuesRow() : base()
        {

        }

        public RevenuesRow(RowFields fields) : base(fields)
        {
