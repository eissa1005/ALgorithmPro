...
using MyRepository = ALgorithmPro.ALgorithm.Repositories.PriceTypesRepository;
using MyRow = ALgorithmPro.ALgorithm.Entities.PriceTypesRow;
using ALgorithmPro.Web.Modules.Common.Common;
using System;

namespace ALgorithmPro.ALgorithm.Endpoints
{
    [Route("Services/ALgorithm/PriceTypes/[action]")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class PriceTypesController : ServiceEndpoint
    {
