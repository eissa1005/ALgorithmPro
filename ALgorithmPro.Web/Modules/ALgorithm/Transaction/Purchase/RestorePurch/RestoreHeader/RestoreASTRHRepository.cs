...
using MyRow = ALgorithmPro.ALgorithm.Entities.RestoreASTRHRow;

namespace ALgorithmPro.ALgorithm.Repositories
{
    public class RestoreASTRHRepository : BaseRepository
    {
        private static MyRow.RowFields Fld => MyRow.Fields;
        public static TRTYType SelectTRTY { set; get; }
        public static List<RestoreASTRDRow> listASTRD { set; get; }
        public RestoreASTRHRepository(IRequestContext context) : base(context)
        {
        ...
        public SaveResponse Create(IUnitOfWork uow, SaveRequest<MyRow> request)
        {
            ...
            try
            {
                ...
                if (SelectTRTY == TRTYType.RestorePurch)
                {
                    ...
                    header.NetTotal = header.Total + header.HTAX + header.HAddtions + header.EXPENSEVL - header.HDISC - header.Paid;
        ...
        public static void ADDACCTRH(IDbConnection connection, RestoreASTRHRow ASTRH)
        {
            if (SelectTRTY == TRTYType.RestorePurch)
            {
