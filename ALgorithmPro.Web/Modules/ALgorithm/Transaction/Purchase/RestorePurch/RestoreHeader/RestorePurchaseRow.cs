...
namespace ALgorithmPro.ALgorithm.Entities
{
    ...
    [LookupScript("ALgorithm.RestorePurchase")]
    public sealed class RestorePurchaseRow : Row<RestorePurchaseRow.RowFields>, IIdRow, INameRow
    {
        ...
        public RestorePurchaseRow()
            : base()
        {
        }

        public RestorePurchaseRow(RowFields fields)
            : base(fields)
        {
        }
