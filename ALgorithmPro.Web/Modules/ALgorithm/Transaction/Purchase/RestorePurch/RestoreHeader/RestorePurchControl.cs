...
{
    [Route("ALgorithm/RestorePurch/[action]")]
    public class RestorePurchControl : Controller
    {
        ...
        public RestorePurchControl(IReportRegistry reportRegistry, IRequestContext context,
        ...
        public IActionResult Index(string key, string opt)
        {
            ...
            return View(MVC.Views.ALgorithm.Transaction.Purchase.RestorePurch.RestoreHeader.RestorePurchInvoice);
