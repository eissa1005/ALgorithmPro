...
{
    [FormScript("ALgorithm.RestoreASTRH")]
    [BasedOnRow(typeof(Entities.RestoreASTRHRow), CheckNames = true)]
    public class RestoreASTRHForm
    {
        [Category("Restore Purchase")]
        ...
        [RestoreASTRDEditor]
        public List<RestoreASTRDRow> DetailList { set; get; }
