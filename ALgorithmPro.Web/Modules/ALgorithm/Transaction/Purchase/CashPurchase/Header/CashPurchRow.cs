...
namespace ALgorithmPro.ALgorithm.Entities
{
    ...
    [DisplayName("Cash Purchase"), InstanceName("Cash Purchase")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    [LookupScript("ALgorithm.CashPurch")]
    public sealed class CashPurchRow : Row<CashPurchRow.RowFields>, IIdRow, INameRow
    {
        ...
        [LookupEditor(typeof(CashPurchTRTYLookup), AutoComplete = true, InplaceAdd = true)]
        public Int32? TR_TY
        {
        ...
        [DisplayName("Store"), Size(100), PrimaryKey, ForeignKey("[dbo].[Stores]", "StoreID"), LeftJoin("jStore"), QuickSearch, NameProperty, TextualField("StoreStoreNameAr")]
        ...
        [DisplayName("Price RATE"), Column("RATE"), DefaultValue(1)]
        public Double? RATE
        {
        ...
        public List<CashPurchASTRDRow> DetailList
        {
        ...
        [DisplayName("Net Total"), DefaultValue(0), ReadOnly(true)]
        ...
        public CashPurchRow(RowFields fields)
            : base(fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowListField<CashPurchASTRDRow> DetailList;
