...
{
    [FormScript("ALgorithm.CashPurch")]
    [BasedOnRow(typeof(Entities.CashPurchRow), CheckNames = true)]
    public class CashPurchForm
    {
        ...
        [CashPurchASTRDEditor]
        public List<CashPurchASTRDRow> DetailList { set; get; }
