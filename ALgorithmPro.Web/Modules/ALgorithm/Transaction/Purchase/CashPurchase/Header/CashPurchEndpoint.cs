...
using MyRepository = ALgorithmPro.ALgorithm.Repositories.CashPurchRepository;
...
{
    [Route("Services/ALgorithm/CashPurch/[action]")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class CashPurchController : ServiceEndpoint
    {
        ...
        public FileContentResult ListExcel(IDbConnection connection, ListRequest request)
        {
            ...
            var report = new DynamicDataReport(data, request.IncludeColumns, typeof(Columns.CashPurchColumns), HttpContext.RequestServices);
