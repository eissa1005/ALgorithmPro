...
{
    [Route("ALgorithm/CashPurchase/[action]")]
    public class CashPurchaseControl : Controller
    {
        ...
        public CashPurchaseControl(IReportRegistry reportRegistry, IRequestContext context,
