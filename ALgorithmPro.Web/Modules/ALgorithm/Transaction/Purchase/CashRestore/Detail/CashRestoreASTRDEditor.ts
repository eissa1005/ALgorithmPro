...
namespace ALgorithmPro.ALgorithm {
    ...
    export class CashRestoreASTRDEditor extends AS.GridEditorBase<CashRestoreASTRDRow> {
        ...
        constructor(container: JQuery) {
            ...
            this.form = new CashRestoreASTRHForm("ALgorithmPro_ALgorithm_CashRestoreASTRHDialog8_");
