...
namespace ALgorithmPro.ALgorithm.Entities
{
    ...
    [LookupScript("ALgorithm.PurchASTRD")]

    public sealed class PurchASTRDRow : Row<PurchASTRDRow.RowFields>, IIdRow, INameRow
    {
        [Hidden]
        ...
        [DisplayName("Package Name"), Column("PKID"), Size(10), Required, DefaultValue(1)]
        ...
        public PurchASTRDRow()
            : base()
        {
        }

        public PurchASTRDRow(RowFields fields)
            : base(fields)
        {
        }
