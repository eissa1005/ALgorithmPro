...
{
    [Route("ALgorithm/Purch/[action]")]
    public class PurchControl : Controller
    {
        ...
        public PurchControl(IReportRegistry reportRegistry, IRequestContext context,
        ...
        public IActionResult Index(string key, string opt)
        {
            ...
            return View(MVC.Views.ALgorithm.Transaction.Purchase.CreditPurchase.PurchaseHeader.InvoicPurchReport);
