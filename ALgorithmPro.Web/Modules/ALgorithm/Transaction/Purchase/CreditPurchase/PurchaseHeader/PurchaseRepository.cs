    ...
    public class PurchaseRepository : BaseRepository
    {
        ...
        public SaveResponse Create(IUnitOfWork uow, SaveRequest<MyRow> request)
        {
            ...
            try
            {
                ...
                int LNNO = 1;
                if (SelectTRTY == TRTYType.Purchase)
                {
                    listASTRD.ForEach(s =>
                    {
                        ...
                        s.TR_DS = (int)TRDSTYPE.Purchase;
                        s.GRP = (int)GRPTYPE.Purchase;
                    ...
                    header.TR_DS = (int)TRDSTYPE.Purchase;
                    header.ACC_NO = ACCNO;
        ...
        public ListResponse<MyRow> List(IDbConnection connection, ListRequest request)
        {
            ...
            try
            {
                if (SelectTRTY == TRTYType.Purchase)
                {
                    lst.Entities = connection.List<MyRow>(s => s.SelectTableFields()).Where<MyRow>(x => x.TR_TY == (int)TRTYType.Purchase).ToList();
                    return lst;
                }
                else
                {
        ...
        public static void ADDACCTRH(IDbConnection connection, PurchaseRow ASTRH)
        {
            if (SelectTRTY == TRTYType.Purchase)
            {
        ...
        public static void ADDACCTRD(IDbConnection connection, ACCTRHRow ACCTRH, PurchaseRow ASTRH)
        {
            if (SelectTRTY == TRTYType.Purchase)
            {
