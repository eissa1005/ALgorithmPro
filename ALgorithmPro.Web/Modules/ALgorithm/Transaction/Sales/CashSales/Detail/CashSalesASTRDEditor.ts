...
namespace ALgorithmPro.ALgorithm {
    ...
    import FLD = ALgorithmPro.ALgorithm.CashSalesASTRDRow.Fields;

    @Serenity.Decorators.registerClass()
    export class CashSalesASTRDEditor extends AS.GridBaseEditor<CashSalesASTRDRow> {
        protected getColumnsKey() { return 'ALgorithm.CashSalesASTRD'; }
        protected getDialogType() { return CashSalesASTRDDialog; }
        ...
        constructor(container: JQuery) {
            ...
            var PrefixId = BS.GetPrefixId(CashSalesForm.formKey);
            this.form = new CashSalesForm(PrefixId);

            // KeyDown 👈
            this.slickGrid.onKeyDown.subscribe((e) => {
                if (e.keyCode == AS.KeyCode.F2) {

                    CashSalesASTRDEditor.GridName = this.slickGrid;
                    SelectTRTY = AS.TRTYType.CashSales;
        ...
        protected validateEntity(row) {
            ...
            let RATE = BS.GetCurrencyRAT(CashSalesDialog.OldValue, CashSalesDialog.NewValue);
