...
namespace ALgorithmPro.ALgorithm.Entities
{
    ...
    [DisplayName("CashSales"), InstanceName("CashSales")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    public sealed class CashSalesRow : Row<CashSalesRow.RowFields>, IIdRow, INameRow
    {
        ...
        [LookupEditor(typeof(CashSalesTRTYLookup), AutoComplete = true, InplaceAdd = true)]
        public Int32? TR_TY
        {
        ...
        public List<CashSalesASTRDRow> DetailList
        {
        ...
        public CashSalesRow(RowFields fields)
            : base(fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowListField<CashSalesASTRDRow> DetailList;
