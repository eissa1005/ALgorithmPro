...
using System.Data;
using System.Linq;
using MyRow = ALgorithmPro.ALgorithm.Entities.CashSalesRow;
using static ALgorithmPro.Contstants;

namespace ALgorithmPro.ALgorithm.Repositories
{
    public class CashSalesRepository : BaseRepository
    {
        private static MyRow.RowFields Fld => MyRow.Fields;
        public static IDbTransaction transaction;
        public static TRTYType SelectTRTY { set; get; }
        public static List<CashSalesASTRDRow> listASTRD { set; get; }
        public CashSalesRepository(IRequestContext context) : base(context)
        {
            SelectTRTY = TRTYType.CashSales;
        ...
        public SaveResponse Create(IUnitOfWork uow, SaveRequest<MyRow> request)
        {
            ...
            try
            {
                ...
                if (SelectTRTY == TRTYType.CashSales)
                {
                    ...
                    header.TR_DS = (int)TRDSTYPE.CashSales;
        ...
        public ListResponse<MyRow> List(IDbConnection connection, ListRequest request)
        {
            ...
            try
            {
                if (SelectTRTY == TRTYType.CashSales)
                {
                    lst.Entities = connection.List<MyRow>(s => s.SelectTableFields()).Where<MyRow>(x => x.TR_TY == (int)TRTYType.CashSales).ToList();
                    return lst;
                }
                else
                {
