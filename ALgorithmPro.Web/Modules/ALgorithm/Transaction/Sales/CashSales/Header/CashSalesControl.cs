...
{
    [Route("ALgorithm/CashSales/[action]")]
    public class CashSalesControl : Controller
    {
        ...
        public CashSalesControl(IReportRegistry reportRegistry, IRequestContext context,
        ...
        public IActionResult Index(string key, string opt)
        {
            ...
            return View(MVC.Views.ALgorithm.Transaction.Sales.CashSales.Header.InvoicReport);
