    ...
    public partial class CashSalesInvoice
    {
        ...
        public void Data(double HeaderID)
        {
            using (var serviceScope = ServiceActivator.GetScope())
            {
                ...
                string SQL = "SELECT * FROM ASTRDVIEW WHERE DetailID=" + HeaderID+ " AND TR_TY="+(int)TRTYType.CashSales+"";
            ...
            try
            {
                using (var serviceScope = ServiceActivator.GetScope())
                {
                    ...
                    using (var connection = ((ISqlConnections)sqlConnections).NewByKey("Default"))
                    {
                        ...
                        string SQL = "SELECT * FROM ASTRDVIEW WHERE DetailID=" + ProHeaderID + " AND TR_TY=" + (int)TRTYType.CashSales + "";
