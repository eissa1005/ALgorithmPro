...
namespace ALgorithmPro.ALgorithm.Entities
{
    ...
    [DisplayName("ReturnSales Detail"), InstanceName("ReturnSales Detail")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    [LookupScript("ALgorithm.ReturnASTRD")]
    public sealed class ReturnASTRDRow : Row<ReturnASTRDRow.RowFields>, IIdRow, INameRow
    {
        [Hidden]
        ...
        [Hidden]
        [DisplayName("DetailID"), Column("DetailID"), NotNull, NameProperty, ForeignKey("[dbo].[ASTRH]", "HeaderID"), LeftJoin("jHeaderID")]
        ...
        [LookupEditor(typeof(CashRestoreTRTYLookup), AutoComplete = true)]
        public Int32? TR_TY
        {
        ...
        [DisplayName("Quantity"), Column("ReturnQty"), DefaultValue(0)]
        ...
        [Hidden]
        [DisplayName("RestoreQty"), Column("RestoreQty"), DefaultValue(0)]
        ...
        public ReturnASTRDRow()
            : base()
        {
        }

        public ReturnASTRDRow(RowFields fields)
            : base(fields)
        {
        }
