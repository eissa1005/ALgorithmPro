...
namespace ALgorithmPro.ALgorithm.Entities
{
    ...
    [DisplayName("Return Sales"), InstanceName("Return Sales")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    public sealed class ReturnSalesRow : Row<ReturnSalesRow.RowFields>, IIdRow, INameRow
    {
        ...
        [LookupEditor(typeof(ReturnTRTYLookup), AutoComplete = true, InplaceAdd = true)]
        public Int32? TR_TY
        {
        ...
        public List<ReturnASTRDRow> DetailList
        {
        ...
        public ReturnSalesRow()
            : base()
        {
        }

        public ReturnSalesRow(RowFields fields)
            : base(fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowListField<ReturnASTRDRow> DetailList;
