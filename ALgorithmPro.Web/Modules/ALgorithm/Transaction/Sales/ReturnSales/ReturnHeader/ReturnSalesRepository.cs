...
using MyRow = ALgorithmPro.ALgorithm.Entities.ReturnSalesRow;

namespace ALgorithmPro.ALgorithm.Repositories
{
    public class ReturnSalesRepository : BaseRepository
    {
        ...
        public ReturnSalesRepository(IRequestContext context) : base(context)
        {
        ...
        public static void ADDACCTRH(IDbConnection connection, ReturnSalesRow ASTRH)
        {
            if (SelectTRTY == TRTYType.ReturnSales)
            {
        ...
        public static void ADDACCTRD(IDbConnection connection, ACCTRHRow ACCTRH, ReturnSalesRow ASTRH)
        {
            if (SelectTRTY == TRTYType.ReturnSales)
            {
