...
{
    [Route("ALgorithm/ReturnSales/[action]")]
    public class ReturnSalesControl : Controller
    {
        ...
        public ReturnSalesControl(IReportRegistry reportRegistry, IRequestContext context,
        ...
        public IActionResult Index(string key, string opt)
        {
            ...
            return View(MVC.Views.ALgorithm.Transaction.Sales.ReturnSales.ReturnHeader.ReturnSalesInvoice);
