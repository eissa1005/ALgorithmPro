...
{
    [FormScript("ALgorithm.ReturnASTRH")]
    [BasedOnRow(typeof(Entities.ReturnASTRHRow), CheckNames = true)]
    public class ReturnASTRHForm
    {
        [Category("ReturnSales Info")]
        ...
        [ReturnASTRDEditor]
        public List<ReturnASTRDRow> DetailList { set; get; }
