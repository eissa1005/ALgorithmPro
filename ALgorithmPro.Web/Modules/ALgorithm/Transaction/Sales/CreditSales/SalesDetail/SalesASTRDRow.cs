...
namespace ALgorithmPro.ALgorithm.Entities
{
    ...
    [DisplayName("Credit Sales"), InstanceName("Credit Sales")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    [LookupScript("ALgorithm.SalesASTRD")]
    public sealed class SalesASTRDRow : Row<SalesASTRDRow.RowFields>, IIdRow, INameRow
    {
        [Hidden]
        ...
        [LookupEditor(typeof(SalesTRTYLookup), AutoComplete = true)]
        public Int32? TR_TY
        {
        ...
        public SalesASTRDRow()
            : base()
        {
        }

        public SalesASTRDRow(RowFields fields)
            : base(fields)
        {
        }
