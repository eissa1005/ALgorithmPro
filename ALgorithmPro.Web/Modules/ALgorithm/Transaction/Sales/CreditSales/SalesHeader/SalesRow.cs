...
namespace ALgorithmPro.ALgorithm.Entities
{
    ...
    public sealed class SalesRow : Row<SalesRow.RowFields>, IIdRow, INameRow
    {
        ...
        [LookupEditor(typeof(SalesTRTYLookup), AutoComplete = true, InplaceAdd = true)]
        public Int32? TR_TY
        {
        ...
        [DisplayName("Paid"), DefaultValue(0)]
        public Double? Paid
        {
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowListField<SalesASTRDRow> DetailList;
