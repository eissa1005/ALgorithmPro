...
namespace ALgorithmPro.ALgorithm.Entities
{
    ...
    [DisplayName("Cash Return"), InstanceName("Cash Return")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    public sealed class CashReturnASTRHRow : Row<CashReturnASTRHRow.RowFields>, IIdRow, INameRow
    {
        ...
        [LookupEditor(typeof(CashReturnTRTYLookup), AutoComplete = true, InplaceAdd = true)]
        public Int32? TR_TY
        {
        ...
        [DisplayName("Reference"), Size(100)]
        ...
        public List<CashReturnASTRDRow> DetailList
        {
        ...
        public CashReturnASTRHRow()
            : base()
        {
        }

        public CashReturnASTRHRow(RowFields fields)
            : base(fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowListField<CashReturnASTRDRow> DetailList;
