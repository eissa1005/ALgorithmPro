...
namespace ALgorithmPro.ALgorithm.Entities
{
    ...
    public sealed class CashReturnRow : Row<CashReturnRow.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("Rep Receive"), Column("REP_CD2"), Size(100)]
        [LookupEditor(typeof(RepsLookup), AutoComplete = true, InplaceAdd = true)]
        ...
        public CashReturnRow()
            : base()
        {
        }

        public CashReturnRow(RowFields fields)
            : base(fields)
        {
        }
