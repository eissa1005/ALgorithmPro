...
{
    [FormScript("ALgorithm.CashReturnASTRH")]
    [BasedOnRow(typeof(Entities.CashReturnASTRHRow), CheckNames = true)]
    public class CashReturnASTRHForm
    {
        [Category("CashReturn Info")]
        ...
        [CashSalesASTRDEditor]
        public List<CashSalesASTRDRow> DetailList { set; get; }
