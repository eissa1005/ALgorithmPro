...
{
    [FormScript("ALgorithm.CashReturn")]
    [BasedOnRow(typeof(Entities.CashReturnRow), CheckNames = true)]
    public class CashReturnForm
    {
        ...
        [CashReturnASTRDEditor]
        public List<CashReturnASTRDRow> DetailList { set; get; }
