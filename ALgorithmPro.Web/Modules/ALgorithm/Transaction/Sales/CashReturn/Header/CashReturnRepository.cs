...
using MyRow = ALgorithmPro.ALgorithm.Entities.CashReturnRow;
using static ALgorithmPro.Contstants;

namespace ALgorithmPro.ALgorithm.Repositories
{
    public class CashReturnRepository : BaseRepository
    {
        ...
        public CashReturnRepository(IRequestContext context) : base(context)
        {
        ...
        public SaveResponse Create(IUnitOfWork uow, SaveRequest<MyRow> request)
        {
            ...
            try
            {
                ...
                if (SelectTRTY == TRTYType.CashReturn)
                {
                    ...
                    header.TR_DS = (int)TRDSTYPE.CashReturn;
