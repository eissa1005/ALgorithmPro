...
namespace ALgorithmPro.ALgorithm {
    ...
    export class CashReturnASTRDEditor extends AS.GridEditorBase<CashReturnASTRDRow> {
        ...
        constructor(container: JQuery) {
            ...
            this.form = new CashReturnASTRHForm("ALgorithmPro_ALgorithm_CashReturnASTRHDialog8_");
            this.heaer = new CashReturnASTRHForm(CashReturnASTRHDialog.PrefixID);
        ...
        protected validateEntity(row: CashReturnASTRDRow, id) {
