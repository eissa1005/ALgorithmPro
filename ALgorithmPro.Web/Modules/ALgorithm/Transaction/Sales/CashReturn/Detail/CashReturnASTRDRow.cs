...
namespace ALgorithmPro.ALgorithm.Entities
{
    ...
    [DisplayName("CashReturn Detail"), InstanceName("CashReturn Detail")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    public sealed class CashReturnASTRDRow : Row<CashReturnASTRDRow.RowFields>, IIdRow, INameRow
    {
        [Hidden]
        ...
        public CashReturnASTRDRow()
            : base()
        {
        }

        public CashReturnASTRDRow(RowFields fields)
            : base(fields)
        {
        }
