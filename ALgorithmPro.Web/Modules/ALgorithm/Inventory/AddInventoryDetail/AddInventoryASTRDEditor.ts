...
namespace ALgorithmPro.ALgorithm {
    ...
    export class AddInventoryASTRDEditor extends AS.GridBaseEditor<AddInventoryASTRDRow> {
        protected getColumnsKey() { return 'ALgorithm.AddInventoryASTRD'; }
        protected getDialogType() { return AddInventoryASTRDDialog; }
        ...
        constructor(container: JQuery) {
            ...
            var PrefixId = BS.GetPrefixId(AddInventoryForm.formKey);
            this.form = new AddInventoryForm(PrefixId);

            // KeyDown 👈
            this.slickGrid.onKeyDown.subscribe((e) => {
                if (e.keyCode == AS.KeyCode.F2) {

                    AddInventoryASTRDEditor.GridName = this.slickGrid;
