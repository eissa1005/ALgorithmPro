...
namespace ALgorithmPro.ALgorithm {
    ...
    import FLD = ALgorithmPro.ALgorithm.AdjustDetailRow.Fields;

    @Serenity.Decorators.registerClass()
    export class AdjustDetailEditor extends AS.GridEditorBase<AdjustDetailRow> {
        protected getColumnsKey() { return 'ALgorithm.AdjustDetail'; }
        protected getDialogType() { return AdjustDetialDialog; }
        protected getLocalTextPrefix() { return AdjustDetailRow.localTextPrefix; }
        ...
        constructor(container: JQuery) {
            ...
            this.form = new AdjustHeaderForm("ALgorithmPro_ALgorithm_AdjustHeaderDialog8_");
        ...
        protected validateEntity(row: AdjustDetailRow, id) {
