...
namespace ALgorithmPro.ALgorithm.Entities
{
    ...
    [DisplayName("AdjustDetial"), InstanceName("AdjustDetail")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    [LookupScript("ALgorithm.AdjustDetail")]
    public sealed class AdjustDetailRow : Row<AdjustDetailRow.RowFields>, IIdRow, INameRow
    {
        [Hidden]
        ...
        public AdjustDetailRow()
            : base()
        {
        }

        public AdjustDetailRow(RowFields fields)
            : base(fields)
        {
        }
