...
namespace ALgorithmPro.ALgorithm {
    ...
    export class AdjustDetialDialog extends Common.GridEditorDialog<AdjustDetailRow> {
        protected getFormKey() { return AdjustDetailForm.formKey; }
        ...
        constructor() {
            ...
            this.form = new AdjustDetailForm(this.idPrefix);
            AdjustDetialDialog.PrefixID = this.form.idPrefix;
