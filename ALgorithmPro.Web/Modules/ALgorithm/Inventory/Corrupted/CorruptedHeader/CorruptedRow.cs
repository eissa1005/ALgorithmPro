...
namespace ALgorithmPro.ALgorithm.Entities
{
    ...
    [LookupScript("ALgorithm.Corrupted")]

    public sealed class CorruptedRow : Row<CorruptedRow.RowFields>, IIdRow, INameRow
    {
        ...
        public List<CorruptedASTRDRow> DetailList
        {
        ...
        public CorruptedRow(RowFields fields)
            : base(fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowListField<CorruptedASTRDRow> DetailList;
