...
using System.Data;
using System.Linq;
using MyRow = ALgorithmPro.ALgorithm.Entities.CorruptedRow;
using static ALgorithmPro.Contstants;

namespace ALgorithmPro.ALgorithm.Repositories
{
    public class CorruptedRepository : BaseRepository
    {
        private static MyRow.RowFields Fld => MyRow.Fields;
        public static TRTYType SelectTRTY { set; get; }
        public static IDbTransaction transaction;
        public static List<CorruptedASTRDRow> listASTRD { set; get; }
        public CorruptedRepository(IRequestContext context) : base(context)
        {
