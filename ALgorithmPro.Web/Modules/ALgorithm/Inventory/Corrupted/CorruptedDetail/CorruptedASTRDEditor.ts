...
namespace ALgorithmPro.ALgorithm {
    ...
    import FLD = ALgorithmPro.ALgorithm.AddInventoryASTRDRow.Fields;

    @Serenity.Decorators.registerClass()
    export class CorruptedASTRDEditor extends AS.GridBaseEditor<CorruptedASTRDRow> {
        protected getColumnsKey() { return 'ALgorithm.CorruptedASTRD'; }
        protected getDialogType() { return CorruptedASTRDDialog; }
        protected getLocalTextPrefix() { return CorruptedASTRDRow.localTextPrefix; }

        public static GridName: Slick.Grid;
        protected form: CorruptedForm;
        ...
        constructor(container: JQuery) {
            ...
            var PrefixId = BS.GetPrefixId(CorruptedForm.formKey);
            this.form = new CorruptedForm(PrefixId);

            // KeyDown 👈
            this.slickGrid.onKeyDown.subscribe((e) => {
                if (e.keyCode == AS.KeyCode.F2) {

                    CorruptedASTRDEditor.GridName = this.slickGrid;
            ...
            this.form.CurrencyID.changeSelect2((e) => {
                ...
                CorruptedDialog.OldValue = oldValue;
                CorruptedDialog.NewValue = NewValue;
        ...
        protected getItemCssClass(item: ALgorithm.CorruptedASTRDRow, index: number): string {
