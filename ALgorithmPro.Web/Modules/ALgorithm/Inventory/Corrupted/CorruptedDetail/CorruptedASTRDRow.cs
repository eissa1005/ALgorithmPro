...
namespace ALgorithmPro.ALgorithm.Entities
{
    ...
    [DisplayName("Corrupted"), InstanceName("Corrupted")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    [LookupScript("ALgorithm.CorruptedASTRD")]
    public sealed class CorruptedASTRDRow : Row<CorruptedASTRDRow.RowFields>, IIdRow, INameRow
    {
        [Hidden]
        ...
        public CorruptedASTRDRow()
            : base()
        {
        }

        public CorruptedASTRDRow(RowFields fields)
            : base(fields)
        {
        }
