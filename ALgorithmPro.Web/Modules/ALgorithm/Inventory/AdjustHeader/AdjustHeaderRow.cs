...
namespace ALgorithmPro.ALgorithm.Entities
{
    ...
    [DisplayName("Adjust"), InstanceName("Adjust")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    [LookupScript("ALgorithm.AdjustHeader")]
    public sealed class AdjustHeaderRow : Row<AdjustHeaderRow.RowFields>, IIdRow, INameRow
    {
        ...
        [LookupEditor(typeof(PurchaseTRTYLookup), AutoComplete = true, InplaceAdd = true)]
        public Int32? TR_TY
        {
        ...
        public List<AdjustDetailRow> DetailList
        {
        ...
        public AdjustHeaderRow()
            : base()
        {
        }

        public AdjustHeaderRow(RowFields fields)
            : base(fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowListField<AdjustDetailRow> DetailList;
