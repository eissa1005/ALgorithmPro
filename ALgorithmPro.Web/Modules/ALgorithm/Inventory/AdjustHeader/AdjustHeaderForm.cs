...
{
    [FormScript("ALgorithm.AdjustHeader")]
    [BasedOnRow(typeof(Entities.AdjustHeaderRow), CheckNames = true)]
    public class AdjustHeaderForm
    {
        [Category("Adjust Info")]
        ...
        [AdjustDetailEditor]
        public List<AdjustDetailRow> DetailList { set; get; }
