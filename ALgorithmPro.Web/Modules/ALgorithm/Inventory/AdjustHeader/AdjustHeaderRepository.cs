...
{
    public class AdjustHeaderRepository : BaseRepository
    {
        private static MyRow.RowFields Fld => MyRow.Fields;
        public static TRTYType SelectTRTY { set; get; }
        public static List<AdjustDetailRow> listASTRD { set; get; }
        public AdjustHeaderRepository(IRequestContext context) : base(context)
        {
