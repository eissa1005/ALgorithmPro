...
namespace ALgorithmPro.ALgorithm.Entities
{
    ...
    [DisplayName("RemoveInventory"), InstanceName("RemoveInventory")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    [LookupScript("ALgorithm.RemoveInventoryASTRD")]
    public sealed class RemoveInventoryASTRDRow : Row<RemoveInventoryASTRDRow.RowFields>, IIdRow, INameRow
    {
        [Hidden]
        ...
        [LookupEditor(typeof(AddInventoryLookup), AutoComplete = true)]
        public Int32? TR_TY
        {
        ...
        public RemoveInventoryASTRDRow()
            : base()
        {
        }

        public RemoveInventoryASTRDRow(RowFields fields)
            : base(fields)
        {
        }
