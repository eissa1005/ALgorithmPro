...
{
    [ColumnsScript("ALgorithm.RemoveInventoryASTRD")]
    [BasedOnRow(typeof(Entities.RemoveInventoryASTRDRow), CheckNames = true)]
    public class RemoveInventoryASTRDColumns
    {
        [Hidden]
