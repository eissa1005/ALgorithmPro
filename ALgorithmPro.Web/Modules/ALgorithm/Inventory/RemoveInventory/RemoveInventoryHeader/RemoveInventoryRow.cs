...
namespace ALgorithmPro.ALgorithm.Entities
{
    ...
    [LookupScript("ALgorithm.RemoveInventory")]

    public sealed class RemoveInventoryRow : Row<RemoveInventoryRow.RowFields>, IIdRow, INameRow
    {
        ...
        [LookupEditor(typeof(RemoveInventoryLookup), AutoComplete = true, InplaceAdd = true)]
        public Int32? TR_TY
        {
        ...
        [DisplayName("Invoice"), Column("TR_NO"), PrimaryKey, NotNull , LookupInclude]
        public Int32? TR_NO
        {
        ...
        [DisplayName("Store Name"), Size(100), PrimaryKey, LookupInclude, ForeignKey("[dbo].[Stores]", "StoreID"), LeftJoin("jStore"), QuickSearch, NameProperty, TextualField("StoreStoreNameAr")]
        ...
        [DisplayName("Reps Number"), Column("REP_CD"), Size(100), LookupInclude]
        ...
        [DisplayName("PStoreID"), Column("PStoreID"), Size(100), DefaultValue(0), LookupInclude]
        ...
        [DisplayName("Price"), Column("PriceID"), Size(100), DefaultValue(0), LookupInclude]
        ...
        [DisplayName("HDISC1"), Column("HDISC1"), DefaultValue(0), LookupInclude]
        ...
        [DisplayName("HDISC2"), Column("HDISC2"), DefaultValue(0), LookupInclude]
        ...
        [DisplayName("HDISC3"), Column("HDISC3"), DefaultValue(0), LookupInclude]
        ...
        [DisplayName("HDISC4"), Column("HDISC4"), DefaultValue(0), LookupInclude]
        ...
        [DisplayName("HTAX1"), Column("HTAX1"), DefaultValue(0), LookupInclude]
        public Double? HTAX1
        {
        ...
        [DisplayName("HTAX2"), Column("HTAX2"), DefaultValue(0), LookupInclude]
        public Double? HTAX2
        {
        ...
        [DisplayName("HTAX3"), Column("HTAX3"), DefaultValue(0), LookupInclude]
        public Double? HTAX3
        {
        ...
        [DisplayName("Balance"), DefaultValue(0), ReadOnly(true), LookupInclude]
        ...
        [DisplayName("Currency"), Size(100), DefaultValue(1), LookupInclude]
        ...
        public List<RemoveInventoryASTRDRow> DetailList
        {
        ...
        [DisplayName("Sum Quantity"), DefaultValue(0), ReadOnly(true),NotMapped]
        public Double? SQTY
        {
            get => fields.SQTY[this];
            set => fields.SQTY[this] = value;
        }
        ...
        public RemoveInventoryRow()
            : base()
        {
        }

        public RemoveInventoryRow(RowFields fields)
            : base(fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowListField<RemoveInventoryASTRDRow> DetailList;
