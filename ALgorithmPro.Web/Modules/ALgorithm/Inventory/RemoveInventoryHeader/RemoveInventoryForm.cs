...
{
    [FormScript("ALgorithm.RemoveInventory")]
    [BasedOnRow(typeof(RemoveInventoryRow), CheckNames = true)]
    public class RemoveInventoryForm
    {
        [Category("RemoveInventory Info")]
        ...
        [RemoveInventoryASTRDEditor]
        public List<RemoveInventoryASTRDRow> DetailList { set; get; }
