...
namespace ALgorithmPro.ALgorithm.Entities
{
    ...
    [DisplayName("AddInventory"), InstanceName("AddInventory")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    [LookupScript("ALgorithm.AddInventoryASTRD")]
    public sealed class AddInventoryASTRDRow : Row<AddInventoryASTRDRow.RowFields>, IIdRow, INameRow
    {
        [Hidden]
        ...
        public AddInventoryASTRDRow()
            : base()
        {
        }

        public AddInventoryASTRDRow(RowFields fields)
            : base(fields)
        {
        }
