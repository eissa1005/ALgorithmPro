...
{
    [FormScript("ALgorithm.AddInventory")]
    [BasedOnRow(typeof(AddInventoryRow), CheckNames = true)]
    public class AddInventoryForm
    {
        [Category("AddInventory Info")]
        ...
        [AddInventoryASTRDEditor]
        public List<AddInventoryASTRDRow> DetailList { set; get; }
