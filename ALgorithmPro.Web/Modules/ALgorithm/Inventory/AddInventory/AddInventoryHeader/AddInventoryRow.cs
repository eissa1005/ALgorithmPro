...
namespace ALgorithmPro.ALgorithm.Entities
{
    ...
    [LookupScript("ALgorithm.AddInventory")]

    public sealed class AddInventoryRow : Row<AddInventoryRow.RowFields>, IIdRow, INameRow
    {
        ...
        [LookupEditor(typeof(AddInventoryLookup), AutoComplete = true, InplaceAdd = true)]
        public Int32? TR_TY
        {
        ...
        public List<AddInventoryASTRDRow> DetailList
        {
        ...
        public AddInventoryRow()
            : base()
        {
        }

        public AddInventoryRow(RowFields fields)
            : base(fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowListField<AddInventoryASTRDRow> DetailList;
