...
using System.Data;
using System.Linq;
using MyRow = ALgorithmPro.ALgorithm.Entities.AddInventoryRow;
using static ALgorithmPro.Contstants;

namespace ALgorithmPro.ALgorithm.Repositories
{
    public class AddInventoryRepository : BaseRepository
    {
        private static MyRow.RowFields Fld => MyRow.Fields;
        public static TRTYType SelectTRTY { set; get; }
        public static IDbTransaction transaction;
        public static List<AddInventoryASTRDRow> listASTRD { set; get; }
        public AddInventoryRepository(IRequestContext context) : base(context)
        {
