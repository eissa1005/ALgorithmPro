...
namespace ALgorithmPro.ALgorithm.Entities
{
    ...
    [LookupScript("ALgorithm.TransferTo")]

    public sealed class TransferToRow : Row<TransferToRow.RowFields>, IIdRow, INameRow
    {
        ...
        public List<TransferToASTRDRow> DetailList
        {
        ...
        public TransferToRow(): base()
        {

        }

        public TransferToRow(RowFields fields): base(fields)
        {
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowListField<TransferToASTRDRow> DetailList;
