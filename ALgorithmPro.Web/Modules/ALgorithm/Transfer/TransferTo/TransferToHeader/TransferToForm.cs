...
{
    [FormScript("ALgorithm.TransferTo")]
    [BasedOnRow(typeof(TransferToRow), CheckNames = true)]
    public class TransferToForm
    {
        [Category("TransferTo Info")]
        ...
        [TransferToASTRDEditor]
        public List<TransferToASTRDRow> DetailList { set; get; }
