...
namespace ALgorithmPro.ALgorithm {
    ...
    import FLD = ALgorithmPro.ALgorithm.TransferToASTRDRow.Fields;

    @Serenity.Decorators.registerClass()
    export class TransferToASTRDEditor extends AS.GridBaseEditor<TransferToASTRDRow> {
        protected getColumnsKey() { return 'ALgorithm.TransferToASTRD'; }
        protected getDialogType() { return TransferToASTRDDialog; }
        ...
        constructor(container: JQuery) {
            ...
            var PrefixId = BS.GetPrefixId(TransferToForm.formKey);
            this.form = new TransferToForm(PrefixId);

            // KeyDown 👈
            this.slickGrid.onKeyDown.subscribe((e) => {
                if (e.keyCode == AS.KeyCode.F2) {

                    TransferToASTRDEditor.GridName = this.slickGrid;
            ...
            this.form.CurrencyID.changeSelect2((e) => {
                ...
                TransferToDialog.OldValue = oldValue;
                TransferToDialog.NewValue = NewValue;
        ...
        protected getItemCssClass(item: ALgorithm.TransferToASTRDRow, index: number): string {
