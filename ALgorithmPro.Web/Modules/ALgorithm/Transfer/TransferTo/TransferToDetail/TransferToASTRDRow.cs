...
namespace ALgorithmPro.ALgorithm.Entities
{
    ...
    [DisplayName("TransferTo"), InstanceName("TransferTo")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    [LookupScript("ALgorithm.TransferToASTRD")]
    public sealed class TransferToASTRDRow : Row<TransferToASTRDRow.RowFields>, IIdRow, INameRow
    {
        [Hidden]
        ...
        public TransferToASTRDRow()
            : base()
        {
        }

        public TransferToASTRDRow(RowFields fields)
            : base(fields)
        {
        }
