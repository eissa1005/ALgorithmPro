...
namespace ALgorithmPro.ALgorithm.Entities
{
    ...
    [DisplayName("TransferIn"), InstanceName("TransferIn")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    [LookupScript("ALgorithm.TransferInASTRD")]
    public sealed class TransferInASTRDRow : Row<TransferInASTRDRow.RowFields>, IIdRow, INameRow
    {
        [Hidden]
        ...
        [Hidden]
        [DisplayName("DetailID"), Column("DetailID"), NameProperty, ForeignKey("[dbo].[ASTRH]", "HeaderID"), LeftJoin("jHeaderID"), LookupInclude]
        ...
        public TransferInASTRDRow(): base()
        {

        }

        public TransferInASTRDRow(RowFields fields): base(fields)
        {
