...
{
    [FormScript("ALgorithm.TransferIn")]
    [BasedOnRow(typeof(TransferInRow), CheckNames = true)]
    public class TransferInForm
    {
        [Category("TransferIn Info")]
        ...
        [TransferInASTRDEditor]
        public List<TransferInASTRDRow> DetailList { set; get; }
