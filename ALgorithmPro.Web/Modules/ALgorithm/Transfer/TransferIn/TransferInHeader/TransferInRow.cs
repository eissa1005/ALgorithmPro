...
namespace ALgorithmPro.ALgorithm.Entities
{
    ...
    [LookupScript("ALgorithm.TransferIn")]

    public sealed class TransferInRow : Row<TransferInRow.RowFields>, IIdRow, INameRow
    {
        ...
        [LookupEditor(typeof(TransferInLookup), AutoComplete = true, InplaceAdd = true)]
        public Int32? TR_TY
        {
        ...
        [DisplayName("Account"), Column("ACC_NO"), Size(100)]
        ...
        [DisplayName("TransferTo Store"), Column("PStoreID"), Size(100), DefaultValue(0), LookupInclude]
        ...
        public List<TransferInASTRDRow> DetailList
        {
        ...
        public TransferInRow()
            : base()
        {
        }

        public TransferInRow(RowFields fields)
            : base(fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowListField<TransferInASTRDRow> DetailList;
