...
{
    [Route("ALgorithm/TransferIn/[action]")]
    public class TransferInControl : Controller
    {
        ...
        public TransferInControl(IReportRegistry reportRegistry, IRequestContext context,
        ...
        public IActionResult Index(string key, string opt)
        {
            ...
            return View(MVC.Views.ALgorithm.Transfer.TransferIn.TransferInHeader.TransferInInvoice);
