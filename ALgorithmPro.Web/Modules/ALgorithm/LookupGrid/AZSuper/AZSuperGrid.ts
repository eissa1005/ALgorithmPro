/// <reference path="../../Supervisors/SupervisorsGrid.ts" />

namespace ALgorithmPro.ALgorithm {

    import FLD = ACCMFRow.Fields;
    @Serenity.Decorators.registerClass()
    export class AZSuperGrid extends SupervisorsGrid {
        ...
        constructor(container: JQuery) {
            ...
            switch (AZSuperDialog.SelectTRTY) {
            ...
            grid.onSelectedRowsChanged.subscribe(() => {
                ...
                var SupervisorsRow: SupervisorsRow = grid.getDataItem(selectedRow);

                if (SupervisorsRow != null || SupervisorsRow.ID > 0) {
                    this.form.SupervisorId.value = SupervisorsRow.SupervisorID;
                    this.form.Supervisor_NAME.value = SupervisorsRow.Name_AR;
                }        
