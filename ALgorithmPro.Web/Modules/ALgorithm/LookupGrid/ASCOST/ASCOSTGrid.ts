/// <reference path="../../ASCST/ASCSTDialog.ts" />

namespace ALgorithmPro.ALgorithm {

    import FLD = ACCMFRow.Fields;
    @Serenity.Decorators.registerClass()
    export class ASCOSTGrid extends ASCSTGrid {
        ...
        constructor(container: JQuery) {
            ...
            switch (ASCOSTDialog.SelectTRTY) {
            ...
            grid.onSelectedRowsChanged.subscribe(() => {
                ...
                var ASCSTRow: ASCSTRow = grid.getDataItem(selectedRow);

                if (ASCSTRow != null || ASCSTRow.ID > 0) {
                    this.form.CST_CD.value = ASCSTRow.CST_CD;
                    this.form.CST_NM_AR.value = ASCSTRow.CST_NM_AR;
                }
