...
namespace ALgorithmPro.ALgorithm {
    ...
    export class SupplierGrid extends ACCMFGrid {
        ...
        constructor(container: JQuery) {
            ...
            switch (SupplierDialog.SelectTRTY) {
                ...
                case AS.TRTYType.Purchase:
                    ...
                    this.IdPrefixed = BS.GetPrefixId(PurchASTRHForm.formKey);
                    this.form = new PurchASTRHForm(this.IdPrefixed);
                    break;
