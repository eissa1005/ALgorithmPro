/// <reference path="../../REPS/REPSGrid.ts" />

namespace ALgorithmPro.ALgorithm {

    import FLD = ACCMFRow.Fields;
    @Serenity.Decorators.registerClass()
    export class ASREPSGrid extends REPSGrid {
        ...
        constructor(container: JQuery) {
            ...
            switch (ASREPSDialog.SelectTRTY) {
            ...
            grid.onSelectedRowsChanged.subscribe(() => {
                ...
                var REPSRow: REPSRow = grid.getDataItem(selectedRow);

                if (REPSRow != null || REPSRow.ID > 0) {
                    this.form.REP_CD.value = REPSRow.REP_CD;
                    this.form.REP_NAME.value = REPSRow.REP_NAME;
                }
