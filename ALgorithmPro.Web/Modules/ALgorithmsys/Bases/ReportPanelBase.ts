    ...
    export class ReportPanelBase<TRequest> extends Serenity.PropertyPanel<TRequest, any> {
        ...
        constructor(container: JQuery, opt?) {
            ...
            this.byId('SubmitButton').click(e => {
                ...
                AS.ReportHelper.execute({ reportKey: this.getReportKey(), params: { Request: this.getReportRequest() }, extension: 'html' });
            ...
            this.byId('DownloadPdfButton').click(e => {
                ...
                AS.ReportHelper.execute({ reportKey: this.getReportKey(), params: { Request: this.getReportRequest() }, extension: 'pdf' });
