...
namespace AS {
    ...
    export function getDays24HourPulse(fromDate: Date, toDate: Date): number {
        ...
        let days = AS.getHours(fromDate, toDate) / 24;
    ...
    export function getMonths(fromDate: Date, toDate: Date): number {
        let months = AS.getDays24HourPulse(fromDate, toDate) / 30;
    ...
    export function getCalenderMonthsCeil(fromDate: Date, toDate: Date): number {
        let months = AS.getCalenderMonths(fromDate, toDate);
    ...
    export function getPeriods(fromDate: Date, toDate: Date, periodUnit: AS.TimeUoM): number {
        if (periodUnit == AS.TimeUoM.Day) {
            let days = AS.getDays(fromDate, toDate);
            return days;
        }
        else if (periodUnit == AS.TimeUoM.Month) {
            let months = AS.getMonths(fromDate, toDate);
            return months == 0 ? 1 : months;
        }
        else if (periodUnit == AS.TimeUoM.CalenderMonth) {
            let calenderMonths = AS.getCalenderMonths(fromDate, toDate);
    ...
    export function initDateTimeRangeEditor(fromDateTimeEditor: AS.DateTimePickerEditor, toDateTimeEditor: AS.DateTimePickerEditor, onChangeHandler?: (e: JQueryEventObject) => void): void {
