...
using System.Linq;
    ...
    {
        public static string GetNameById<TRow>(this IDbConnection connection, object id) where TRow : class, IIdRow, INameRow, new()
        {
        ...
        public static object GetIdByName<TRow>(this IDbConnection connection, string name)where TRow : class, IIdRow, INameRow, new()
        {
        ...
        public static List<string> GetNamesByIds<TRow>(this IDbConnection connection, IEnumerable<Int64> ids)
            where TRow : class, IIdRow, INameRow, new()
        {
            var row = new TRow();
        ...
        public static TRow TryFirstByName<TRow>(this IDbConnection connection, string name) where TRow : class, IIdRow, INameRow, new()
        {
            if (name == null) return default(TRow);
