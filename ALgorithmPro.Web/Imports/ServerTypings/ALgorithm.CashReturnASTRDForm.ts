namespace ALgorithmPro.ALgorithm {
    export interface CashReturnASTRDForm {
    ...
    export class CashReturnASTRDForm extends Serenity.PrefixedContext {
        static formKey = 'ALgorithm.CashReturnASTRD';
        private static init: boolean;

        constructor(prefix: string) {
            super(prefix);

            if (!CashReturnASTRDForm.init)  {
                CashReturnASTRDForm.init = true;
                ...
                Q.initFormType(CashReturnASTRDForm, [
                    'ID', w0,
                    'DetailID', w0,
                    'PKID', w1,
                    'PK', w2,
