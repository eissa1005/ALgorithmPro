namespace ALgorithmPro.ALgorithm {
    export interface TransferToForm {
        ...
        DetailList: TransferToASTRDEditor;
    ...
    export class TransferToForm extends Serenity.PrefixedContext {
        static formKey = 'ALgorithm.TransferTo';
        private static init: boolean;

        constructor(prefix: string) {
            super(prefix);

            if (!TransferToForm.init)  {
                TransferToForm.init = true;
                ...
                var w7 = s.EnumEditor;
                var w8 = s.DateEditor;
                var w9 = TransferToASTRDEditor;

                Q.initFormType(TransferToForm, [
                    'TR_TY', w0,
                    'StoreID', w0,
                    'DocTransNo', w1,
                    'TR_NO', w2,
