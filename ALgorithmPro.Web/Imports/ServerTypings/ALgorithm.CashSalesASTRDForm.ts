namespace ALgorithmPro.ALgorithm {
    export interface CashSalesASTRDForm {
    ...
    export class CashSalesASTRDForm extends Serenity.PrefixedContext {
        static formKey = 'ALgorithm.CashSalesASTRD';
        private static init: boolean;

        constructor(prefix: string) {
            super(prefix);

            if (!CashSalesASTRDForm.init)  {
                CashSalesASTRDForm.init = true;
                ...
                Q.initFormType(CashSalesASTRDForm, [
                    'ID', w0,
                    'DetailID', w0,
                    'PKID', w1,
                    'PK', w2,
