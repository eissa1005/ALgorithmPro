namespace ALgorithmPro.ALgorithm {
    export interface ReturnASTRDForm {
    ...
    export class ReturnASTRDForm extends Serenity.PrefixedContext {
        static formKey = 'ALgorithm.ReturnASTRD';
        private static init: boolean;

        constructor(prefix: string) {
            super(prefix);

            if (!ReturnASTRDForm.init)  {
                ReturnASTRDForm.init = true;
                ...
                Q.initFormType(ReturnASTRDForm, [
                    'ID', w0,
                    'DetailID', w0,
                    'PKID', w1,
                    'PK', w2,
