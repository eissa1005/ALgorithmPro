namespace ALgorithmPro.ALgorithm {
    export interface CashSalesForm {
    ...
    export class CashSalesForm extends Serenity.PrefixedContext {
        static formKey = 'ALgorithm.CashSales';
        private static init: boolean;

        constructor(prefix: string) {
            super(prefix);

            if (!CashSalesForm.init)  {
                CashSalesForm.init = true;
