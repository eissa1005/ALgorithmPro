namespace ALgorithmPro.ALgorithm {
    export interface CorruptedForm {
        ...
        DetailList: CorruptedASTRDEditor;
    ...
    export class CorruptedForm extends Serenity.PrefixedContext {
        static formKey = 'ALgorithm.Corrupted';
        private static init: boolean;

        constructor(prefix: string) {
            super(prefix);

            if (!CorruptedForm.init)  {
                CorruptedForm.init = true;
                ...
                var w7 = s.EnumEditor;
                var w8 = s.DateEditor;
                var w9 = CorruptedASTRDEditor;

                Q.initFormType(CorruptedForm, [
                    'TR_TY', w0,
                    'StoreID', w0,
                    'DocTransNo', w1,
                    'TR_NO', w2,
