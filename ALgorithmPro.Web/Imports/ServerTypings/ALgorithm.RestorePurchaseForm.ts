namespace ALgorithmPro.ALgorithm {
    export interface RestorePurchaseForm {
    ...
    export class RestorePurchaseForm extends Serenity.PrefixedContext {
        static formKey = 'ALgorithm.RestorePurchase';
        private static init: boolean;

        constructor(prefix: string) {
            super(prefix);

            if (!RestorePurchaseForm.init)  {
                RestorePurchaseForm.init = true;
                ...
                var w7 = s.EnumEditor;
                var w8 = s.DateEditor;
                var w9 = RestoreASTRDEditor;

                Q.initFormType(RestorePurchaseForm, [
                    'TR_TY', w0,
                    'StoreID', w0,
                    'CashBoxID', w0,
                    'TR_NO', w1,
