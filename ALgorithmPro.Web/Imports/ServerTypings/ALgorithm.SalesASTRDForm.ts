namespace ALgorithmPro.ALgorithm {
    export interface SalesASTRDForm {
    ...
    export class SalesASTRDForm extends Serenity.PrefixedContext {
        static formKey = 'ALgorithm.SalesASTRD';
        private static init: boolean;

        constructor(prefix: string) {
            super(prefix);

            if (!SalesASTRDForm.init)  {
                SalesASTRDForm.init = true;
