namespace ALgorithmPro.ALgorithm {
    export interface TransferToASTRDForm {
    ...
    export class TransferToASTRDForm extends Serenity.PrefixedContext {
        static formKey = 'ALgorithm.TransferToASTRD';
        private static init: boolean;

        constructor(prefix: string) {
            super(prefix);

            if (!TransferToASTRDForm.init)  {
                TransferToASTRDForm.init = true;
                ...
                Q.initFormType(TransferToASTRDForm, [
                    'ID', w0,
                    'DetailID', w0,
                    'PKID', w1,
                    'PK', w2,
