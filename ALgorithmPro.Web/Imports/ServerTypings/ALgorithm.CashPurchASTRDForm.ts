namespace ALgorithmPro.ALgorithm {
    export interface CashPurchASTRDForm {
    ...
    export class CashPurchASTRDForm extends Serenity.PrefixedContext {
        static formKey = 'ALgorithm.CashPurchASTRD';
        private static init: boolean;

        constructor(prefix: string) {
            super(prefix);

            if (!CashPurchASTRDForm.init)  {
                CashPurchASTRDForm.init = true;
                ...
                Q.initFormType(CashPurchASTRDForm, [
                    'ID', w0,
                    'DetailID', w0,
                    'PKID', w1,
                    'PK', w2,
