namespace ALgorithmPro.ALgorithm {
    export interface RemoveInventoryASTRDForm {
    ...
    export class RemoveInventoryASTRDForm extends Serenity.PrefixedContext {
        static formKey = 'ALgorithm.RemoveInventoryASTRD';
        private static init: boolean;

        constructor(prefix: string) {
            super(prefix);

            if (!RemoveInventoryASTRDForm.init)  {
                RemoveInventoryASTRDForm.init = true;
                ...
                Q.initFormType(RemoveInventoryASTRDForm, [
                    'ID', w0,
                    'DetailID', w0,
                    'PKID', w1,
                    'PK', w2,
