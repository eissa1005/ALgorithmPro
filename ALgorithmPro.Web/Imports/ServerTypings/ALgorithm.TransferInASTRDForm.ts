namespace ALgorithmPro.ALgorithm {
    export interface TransferInASTRDForm {
    ...
    export class TransferInASTRDForm extends Serenity.PrefixedContext {
        static formKey = 'ALgorithm.TransferInASTRD';
        private static init: boolean;

        constructor(prefix: string) {
            super(prefix);

            if (!TransferInASTRDForm.init)  {
                TransferInASTRDForm.init = true;
                ...
                Q.initFormType(TransferInASTRDForm, [
                    'ID', w0,
                    'DetailID', w0,
                    'PKID', w1,
                    'PK', w2,
