namespace ALgorithmPro.ALgorithm {
    export interface RemoveInventoryForm {
        ...
        DetailList: RemoveInventoryASTRDEditor;
    ...
    export class RemoveInventoryForm extends Serenity.PrefixedContext {
        static formKey = 'ALgorithm.RemoveInventory';
        private static init: boolean;

        constructor(prefix: string) {
            super(prefix);

            if (!RemoveInventoryForm.init)  {
                RemoveInventoryForm.init = true;
                ...
                var w7 = s.EnumEditor;
                var w8 = s.DateEditor;
                var w9 = RemoveInventoryASTRDEditor;

                Q.initFormType(RemoveInventoryForm, [
                    'TR_TY', w0,
                    'StoreID', w0,
                    'DocTransNo', w1,
                    'TR_NO', w2,
