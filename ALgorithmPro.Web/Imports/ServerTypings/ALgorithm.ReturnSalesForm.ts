namespace ALgorithmPro.ALgorithm {
    export interface ReturnSalesForm {
    ...
    export class ReturnSalesForm extends Serenity.PrefixedContext {
        static formKey = 'ALgorithm.ReturnSales';
        private static init: boolean;

        constructor(prefix: string) {
            super(prefix);

            if (!ReturnSalesForm.init)  {
                ReturnSalesForm.init = true;
                ...
                Q.initFormType(ReturnSalesForm, [
                    'TR_TY', w0,
                    'StoreID', w0,
                    'CashBoxID', w0,
                    'TR_NO', w1,
