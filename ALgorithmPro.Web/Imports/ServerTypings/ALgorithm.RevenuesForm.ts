namespace ALgorithmPro.ALgorithm {
    ...
    export class RevenuesForm extends Serenity.PrefixedContext {
        static formKey = 'ALgorithm/Revenues';
        private static init: boolean;

        constructor(prefix: string) {
            super(prefix);

            if (!RevenuesForm.init)  {
                RevenuesForm.init = true;
