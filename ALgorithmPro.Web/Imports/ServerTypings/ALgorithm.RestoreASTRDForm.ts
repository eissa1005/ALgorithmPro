namespace ALgorithmPro.ALgorithm {
    export interface RestoreASTRDForm {
    ...
    export class RestoreASTRDForm extends Serenity.PrefixedContext {
        static formKey = 'ALgorithm.RestoreASTRD';
        private static init: boolean;

        constructor(prefix: string) {
            super(prefix);

            if (!RestoreASTRDForm.init)  {
                RestoreASTRDForm.init = true;
                ...
                Q.initFormType(RestoreASTRDForm, [
                    'ID', w0,
                    'DetailID', w0,
                    'PKID', w1,
                    'PK', w2,
