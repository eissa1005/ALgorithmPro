namespace ALgorithmPro.ALgorithm {
    export interface PurchASTRDRow {
        ID?: number;
        DetailID?: number;
        HeaderID?: number;
        TR_TY?: number;
    ...
    export namespace PurchASTRDRow {
        export const idProperty = 'ID';
        export const nameProperty = 'HeaderID';
        export const localTextPrefix = 'ALgorithm.PurchASTRD';
        export const lookupKey = 'ALgorithm.PurchASTRD';

        export function getLookup(): Q.Lookup<PurchASTRDRow> {
            return Q.getLookup<PurchASTRDRow>('ALgorithm.PurchASTRD');
        }
