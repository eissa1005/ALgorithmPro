namespace ALgorithmPro.ALgorithm {
    export interface CashPurchForm {
    ...
    export class CashPurchForm extends Serenity.PrefixedContext {
        static formKey = 'ALgorithm.CashPurch';
        private static init: boolean;

        constructor(prefix: string) {
            super(prefix);

            if (!CashPurchForm.init)  {
                CashPurchForm.init = true;
                ...
                var w7 = s.EnumEditor;
                var w8 = s.DateEditor;
                var w9 = CashPurchASTRDEditor;

                Q.initFormType(CashPurchForm, [
                    'TR_TY', w0,
                    'StoreID', w0,
                    'CashBoxID', w0,
                    'TR_NO', w1,
