namespace ALgorithmPro.ALgorithm {
    ...
    export namespace CashPayedRow {
        export const idProperty = 'HeaderID';
        export const nameProperty = 'TR_TY';
        export const localTextPrefix = 'ALgorithm.CashPayed';
        export const lookupKey = 'ALgorithm.CashPayed';

        export function getLookup(): Q.Lookup<CashPayedRow> {
            return Q.getLookup<CashPayedRow>('ALgorithm.CashPayed');
        }
