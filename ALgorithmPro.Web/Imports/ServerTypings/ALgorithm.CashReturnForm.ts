namespace ALgorithmPro.ALgorithm {
    export interface CashReturnForm {
    ...
    export class CashReturnForm extends Serenity.PrefixedContext {
        static formKey = 'ALgorithm.CashReturn';
        private static init: boolean;

        constructor(prefix: string) {
            super(prefix);

            if (!CashReturnForm.init)  {
                CashReturnForm.init = true;
                ...
                var w7 = s.EnumEditor;
                var w8 = s.DateEditor;
                var w9 = CashReturnASTRDEditor;

                Q.initFormType(CashReturnForm, [
                    'TR_TY', w0,
                    'StoreID', w0,
                    'CashBoxID', w0,
                    'TR_NO', w1,
