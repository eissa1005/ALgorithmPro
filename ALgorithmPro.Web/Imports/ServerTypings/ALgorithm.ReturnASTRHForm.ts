namespace ALgorithmPro.ALgorithm {
    export interface ReturnASTRHForm {
    ...
    export class ReturnASTRHForm extends Serenity.PrefixedContext {
        static formKey = 'ALgorithm.ReturnASTRH';
        private static init: boolean;

        constructor(prefix: string) {
            super(prefix);

            if (!ReturnASTRHForm.init)  {
                ReturnASTRHForm.init = true;
                ...
                var w7 = s.EnumEditor;
                var w8 = s.DateEditor;
                var w9 = ReturnASTRDEditor;

                Q.initFormType(ReturnASTRHForm, [
                    'TR_TY', w0,
                    'StoreID', w0,
                    'CashBoxID', w0,
                    'TR_NO', w1,
