namespace ALgorithmPro.ALgorithm {
    export interface AdjustDetailForm {
    ...
    export class AdjustDetailForm extends Serenity.PrefixedContext {
        static formKey = 'ALgorithm.AdjustDetail';
        private static init: boolean;

        constructor(prefix: string) {
            super(prefix);

            if (!AdjustDetailForm.init)  {
                AdjustDetailForm.init = true;
                ...
                Q.initFormType(AdjustDetailForm, [
                    'ID', w0,
                    'DetailID', w0,
                    'PKID', w1,
                    'PK', w2,
