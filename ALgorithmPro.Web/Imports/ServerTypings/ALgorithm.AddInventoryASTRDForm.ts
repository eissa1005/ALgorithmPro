namespace ALgorithmPro.ALgorithm {
    export interface AddInventoryASTRDForm {
    ...
    export class AddInventoryASTRDForm extends Serenity.PrefixedContext {
        static formKey = 'ALgorithm.AddInventoryASTRD';
        private static init: boolean;

        constructor(prefix: string) {
            super(prefix);

            if (!AddInventoryASTRDForm.init)  {
                AddInventoryASTRDForm.init = true;
                ...
                Q.initFormType(AddInventoryASTRDForm, [
                    'ID', w0,
                    'DetailID', w0,
                    'PKID', w1,
                    'PK', w2,
