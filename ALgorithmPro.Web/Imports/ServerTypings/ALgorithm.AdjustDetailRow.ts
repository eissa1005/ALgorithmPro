namespace ALgorithmPro.ALgorithm {
    export interface AdjustDetailRow {
        ID?: number;
        DetailID?: number;
        HeaderID?: number;
        TR_TY?: number;
    ...
    export namespace AdjustDetailRow {
        export const idProperty = 'ID';
        export const nameProperty = 'HeaderID';
        export const localTextPrefix = 'ALgorithm.AdjustDetail';
        export const lookupKey = 'ALgorithm.AdjustDetail';

        export function getLookup(): Q.Lookup<AdjustDetailRow> {
            return Q.getLookup<AdjustDetailRow>('ALgorithm.AdjustDetail');
        }
