namespace ALgorithmPro.ALgorithm {
    export interface CashReturnASTRHForm {
    ...
    export class CashReturnASTRHForm extends Serenity.PrefixedContext {
        static formKey = 'ALgorithm.CashReturnASTRH';
        private static init: boolean;

        constructor(prefix: string) {
            super(prefix);

            if (!CashReturnASTRHForm.init)  {
                CashReturnASTRHForm.init = true;
                ...
                var w7 = s.EnumEditor;
                var w8 = s.DateEditor;
                var w9 = CashSalesASTRDEditor;

                Q.initFormType(CashReturnASTRHForm, [
                    'TR_TY', w0,
                    'StoreID', w0,
                    'CashBoxID', w0,
                    'TR_NO', w1,
