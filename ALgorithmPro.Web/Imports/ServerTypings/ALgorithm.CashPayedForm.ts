namespace ALgorithmPro.ALgorithm {
    export interface CashPayedForm {
    ...
    export class CashPayedForm extends Serenity.PrefixedContext {
        static formKey = 'ALgorithm/CashPayed';
        private static init: boolean;

        constructor(prefix: string) {
            super(prefix);

            if (!CashPayedForm.init)  {
                CashPayedForm.init = true;
