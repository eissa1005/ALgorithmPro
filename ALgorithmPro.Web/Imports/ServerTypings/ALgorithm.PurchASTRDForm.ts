namespace ALgorithmPro.ALgorithm {
    export interface PurchASTRDForm {
    ...
    export class PurchASTRDForm extends Serenity.PrefixedContext {
        static formKey = 'ALgorithm.PurchASTRD';
        private static init: boolean;

        constructor(prefix: string) {
            super(prefix);

            if (!PurchASTRDForm.init)  {
                PurchASTRDForm.init = true;
