namespace ALgorithmPro.ALgorithm {
    ...
    export namespace RevenuesRow {
        export const idProperty = 'HeaderID';
        export const nameProperty = 'TR_TY';
        export const localTextPrefix = 'ALgorithm.Revenues';
        export const lookupKey = 'ALgorithm.Revenues';

        export function getLookup(): Q.Lookup<RevenuesRow> {
            return Q.getLookup<RevenuesRow>('ALgorithm.Revenues');
        }
