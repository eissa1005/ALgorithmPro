namespace ALgorithmPro.ALgorithm {
    export interface RestoreASTRHForm {
    ...
    export class RestoreASTRHForm extends Serenity.PrefixedContext {
        static formKey = 'ALgorithm.RestoreASTRH';
        private static init: boolean;

        constructor(prefix: string) {
            super(prefix);

            if (!RestoreASTRHForm.init)  {
                RestoreASTRHForm.init = true;
                ...
                Q.initFormType(RestoreASTRHForm, [
                    'TR_TY', w0,
                    'StoreID', w0,
                    'CashBoxID', w0,
                    'TR_NO', w1,
