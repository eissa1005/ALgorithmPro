namespace ALgorithmPro.ALgorithm {
    export interface CorruptedASTRDForm {
    ...
    export class CorruptedASTRDForm extends Serenity.PrefixedContext {
        static formKey = 'ALgorithm.CorruptedASTRD';
        private static init: boolean;

        constructor(prefix: string) {
            super(prefix);

            if (!CorruptedASTRDForm.init)  {
                CorruptedASTRDForm.init = true;
                ...
                Q.initFormType(CorruptedASTRDForm, [
                    'ID', w0,
                    'DetailID', w0,
                    'PKID', w1,
                    'PK', w2,
