using ALgorithmPro.AppServices;
...
namespace ALgorithmPro
{
    public partial class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //var connection = Configuration.GetSection("Data:ASDB:ConnectionString");
            //services.AddDbContext<ASDBContext>(options => options.UseSqlServer(connection.Value));
